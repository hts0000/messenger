...
export const hello = $root.hello = (() => {
    ...
    hello.v1 = (function() {
        ...
        v1.Greeter = (function() {
            ...
            /**
             * Callback as used by {@link hello.v1.Greeter#sayHello}.
             * @memberof hello.v1.Greeter
             * @typedef SayHelloCallback
             * @type {function}
             * @param {Error|null} error Error, if any
             * @param {hello.v1.HelloResponse} [response] HelloResponse
             */
             ...
             * @memberof hello.v1.Greeter
             * @instance
             * @param {hello.v1.IHelloRequest} request HelloRequest message or plain object
             * @param {hello.v1.Greeter.SayHelloCallback} callback Node-style callback called with the error, if any, and HelloResponse
             * @returns {undefined}
             * @variation 1
             */
            Object.defineProperty(Greeter.prototype.sayHello = function sayHello(request, callback) {
                return this.rpcCall(sayHello, $root.hello.v1.HelloRequest, $root.hello.v1.HelloResponse, request, callback);
            }, "name", { value: "SayHello" });
             ...
             * @instance
             * @param {hello.v1.IHelloRequest} request HelloRequest message or plain object
             * @returns {Promise<hello.v1.HelloResponse>} Promise
             * @variation 2
             */
        ...
        v1.HelloRequest = (function() {
             ...
             * @constructor
             * @param {hello.v1.IHelloRequest=} [properties] Properties to set
             */
             ...
             * HelloRequest name.
             * @member {string} name
             * @memberof hello.v1.HelloRequest
             * @instance
             */
             ...
             * @returns {hello.v1.HelloRequest} HelloRequest
            ...
            HelloRequest.decode = function decode(reader, length) {
                ...
                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.hello.v1.HelloRequest();
            ...
            HelloRequest.fromObject = function fromObject(object) {
                if (object instanceof $root.hello.v1.HelloRequest)
                    return object;
                let message = new $root.hello.v1.HelloRequest();
                if (object.name != null)
             ...
             * @memberof hello.v1.HelloRequest
             * @static
             * @param {hello.v1.HelloRequest} message HelloRequest
            ...
            HelloRequest.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                ...
                return typeUrlPrefix + "/hello.v1.HelloRequest";
            };

            return HelloRequest;
        })();

        v1.HelloResponse = (function() {
             ...
             * @constructor
             * @param {hello.v1.IHelloResponse=} [properties] Properties to set
             */
             ...
             * @memberof hello.v1.HelloResponse
             * @instance
             */
             ...
             * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
             * @param {number} [length] Message length if known beforehand
             * @returns {hello.v1.HelloResponse} HelloResponse
             * @throws {Error} If the payload is not a reader or valid buffer
             * @throws {$protobuf.util.ProtocolError} If required fields are missing
             */
            HelloResponse.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.hello.v1.HelloResponse();
                while (reader.pos < end) {
                    let tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1: {
            ...
            HelloResponse.fromObject = function fromObject(object) {
                if (object instanceof $root.hello.v1.HelloResponse)
                    return object;
                let message = new $root.hello.v1.HelloResponse();
             ...
             * @memberof hello.v1.HelloResponse
             * @static
             * @param {hello.v1.HelloResponse} message HelloResponse
             * @param {$protobuf.IConversionOptions} [options] Conversion options
             * @returns {Object.<string,*>} Plain object
             */
            ...
            HelloResponse.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                ...
                return typeUrlPrefix + "/hello.v1.HelloResponse";
            };
